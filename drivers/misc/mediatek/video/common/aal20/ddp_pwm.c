...
//printk("disp_pwm_set_backlight_cmdq(id = 0x%x, level_1024 = %d), old = %d", id, level_1024,old_pwm);
#if defined(LYCONFIG_REDUCE_BACKLIGHT_SUPPORT)
	//PWM_MSG("disp_pwm_set_backlight level_1024=%d\n",level_1024);
#if defined(LYCONFIG_AUTO_PLATFORM_NAME_F6) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F6B)
	level_1024 =  level_1024*7/10;
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F5B) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5BE) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5C)
	level_1024 =  level_1024*9/10;
#else
	level_1024 =  level_1024*6/10;
#endif
#endif
