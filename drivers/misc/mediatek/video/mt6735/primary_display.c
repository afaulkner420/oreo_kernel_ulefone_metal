...
#define GPIO_DSI_TE_PIN_M_EINT   GPIO_MODE_01
...
#ifdef GPIO_DSI_TE_PIN
#ifndef CONFIG_FPGA_EARLY_PORTING
	gpio_mode = GPIO_DSI_TE_PIN_M_EINT;
...
#endif
	/* / Esd Check : EXT TE */
	if((pgc->plcm->params->dsi.lcm_ext_te_enable==1) && (pgc->plcm->params->dsi.esd_check_enable==1)){
