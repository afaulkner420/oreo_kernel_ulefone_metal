...
#if defined(HS021_TT_KS5503K_TP_BUTTON)
#define TPD_KEYS                {KEY_BACK, KEY_HOMEPAGE, KEY_MENU}
#else
#define TPD_KEYS                {KEY_MENU, KEY_HOMEPAGE, KEY_BACK}
#endif

#if defined(__DRV_LCM_RESOLUTION_WVGA_DRT__)
#define TPD_KEYS_DIM            {{80,900,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {240,900,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {400,900,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}}
#elif defined(__DRV_LCM_RESOLUTION_FWVGA_DRT__)
#define TPD_KEYS_DIM            {{80,900,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {240,900,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {400,900,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}}
#elif defined(__DRV_LCM_RESOLUTION_QHD_DRT__)
#define TPD_KEYS_DIM            {{90,1080,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {270,1080,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {450,1080,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}}
#elif defined(__DRV_LCM_RESOLUTION_HD720_DRT__)
#define TPD_KEYS_DIM            {{120,1350,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {360,1350,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {600,1350,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}}
#elif defined(__DRV_LCM_RESOLUTION_FHD_DRT__)
#define TPD_KEYS_DIM            {{160,2100,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {540,2100,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {920,2100,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}}
#endif
#endif
#endif
...
#if  defined(CONFIG_TPD_SEND_CFG)
...
#if  defined(CONFIG_TPD_GESTURE)
#define CONFIG_GTP_SLIDE_WAKEUP 1
#else
//#define CONFIG_GTP_SLIDE_WAKEUP    0
#endif
